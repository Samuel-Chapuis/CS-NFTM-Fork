...
# build your query
query = "((keyword:'NTM' OR keyword:'NFTM') OR (keyword:'Neural Turing Machine' OR keyword:'Neural Field Turing Machine') AND type:{(Journal)} AND onlinedatefrom:2020-01-01 AND onlinedateto:2025-10-01"
