...
% Make the title page
\frame{\titlepage}
\input{sections/NS-Foundation.tex}
\input{sections/NS-Simplified.tex}
\input{sections/Burger_equation.tex}
\input{sections/1D_Burger_Eq_Dataset.tex}
\input{sections/NFTM1.tex}
\input{sections/NFTM_1D_Burger_RecurrentCNN.tex}
% HAHAAHS
